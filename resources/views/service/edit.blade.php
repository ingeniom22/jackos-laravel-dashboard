                    ...
                    <form action="{{ route('service.update', $service->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="service_name" id="service_name"
                                class="form-input mt-1 block w-full" value="{{ $service->service }}" />
                        </div>

                        <div class="mb-4">
                            <label for="service_description" class="block text-sm font-medium text-gray-600">Service
                                Description:</label>
                            <input type="text" name="description" id="description" class="form-input mt-1 block w-full"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="contract_start" id="contract_start"
                                class="form-input mt-1 block w-full" value="{{ $service->effective_start_date}}" />
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="contract_end" id="contract_end"
                                class="form-input mt-1 block w-full" value="{{ $service->effective_end_date}}" />
                        </div>
