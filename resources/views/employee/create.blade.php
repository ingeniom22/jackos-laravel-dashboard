                    ...
                    <form action="{{ route('employee.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="employee_name" class="block text-sm font-medium text-gray-600">Employee
                                Name:</label>
                            <input type="text" name="employee_name" id="employee_name" class="form-input mt-1 block w-full required" />
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone_no" id="phone_no" class="form-input mt-1 block w-full required" />
                        </div>

                        <div class="mb-4">
                            <label for="contract_start" class="block text-sm font-medium text-gray-600">Contract Start
                                Date:</label>
                            <input type="date" name="contract_start_date" id="contract_start_date" class="form-input mt-1 block w-full required" />
                        </div>

                        <div class="mb-4">
                            <label for="contract_end" class="block text-sm font-medium text-gray-600">Contract End
                                Date:</label>
                            <input type="date" name="contract_end_date" id="contract_end_date" class="form-input mt-1 block w-full required" />
                        </div>
